 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Yuhang Li");
		  toPrint += p1.toString("yli3048");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("I-Ping Huang");
		  toPrint += p2.toString("ihuang9");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Qiusen Huang");
		  toPrint += p3.toString("qhuang79");
		  //Person4 replace P4 with your name
          //and gburdell4 with your gt id
          Person4 p4 = new Person4("Vincent Lieng");
          toPrint += p4.toString("vlieng3");
